...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        #maxQ = self.computeActionFromQValues(state) this wouldnt work bc of infinite recursion
    ...
    def getAction(self, state):
        ...
        action = None
        "*** YOUR CODE HERE ***"
        #aval action entekhab she bad explore  probability epsilon
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        #(1 - alpha)*Q(s,a) + alpha*(reward + discount*max_a' Q(s',a'))
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        # tried multiplying directly before but it crashed
    ...
    def update(self, state, action, nextState, reward):
        ...
        # forgot to use alpha earlier so weights didn't change
        for f in features:
